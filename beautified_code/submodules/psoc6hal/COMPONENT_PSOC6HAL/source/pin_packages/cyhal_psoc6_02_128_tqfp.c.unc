...
const cyhal_resource_pin_mapping_t cyhal_pin_map_audioss_clk_i2s_if[4] = {
	...
	{&CYHAL_I2S_1, P13_0, (uint8_t)CY_GPIO_DM_HIGHZ, P13_0_AUDIOSS1_CLK_I2S_IF},
};
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_audioss_pdm_clk[2] = {
	...
	{&CYHAL_PDM_0, P12_4, (uint8_t)CY_GPIO_DM_STRONG_IN_OFF, P12_4_AUDIOSS0_PDM_CLK},
};
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_audioss_pdm_data[2] = {
	...
	{&CYHAL_PDM_0, P12_5, (uint8_t)CY_GPIO_DM_HIGHZ, P12_5_AUDIOSS0_PDM_DATA},
};

/* Connections for: audioss_rx_sck */
const cyhal_resource_pin_mapping_t cyhal_pin_map_audioss_rx_sck[4] = {
	{&CYHAL_I2S_0, P5_4, (uint8_t)CY_GPIO_DM_STRONG_IN_OFF, P5_4_AUDIOSS0_RX_SCK},
	{&CYHAL_I2S_0, P9_4, (uint8_t)CY_GPIO_DM_STRONG_IN_OFF, P9_4_AUDIOSS0_RX_SCK},
	{&CYHAL_I2S_1, P11_4, (uint8_t)CY_GPIO_DM_STRONG_IN_OFF, P11_4_AUDIOSS1_RX_SCK},
	{&CYHAL_I2S_1, P13_4, (uint8_t)CY_GPIO_DM_STRONG_IN_OFF, P13_4_AUDIOSS1_RX_SCK},
};
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_audioss_rx_sdi[4] = {
	...
	{&CYHAL_I2S_0, P9_6, (uint8_t)CY_GPIO_DM_HIGHZ, P9_6_AUDIOSS0_RX_SDI},
	{&CYHAL_I2S_1, P11_6, (uint8_t)CY_GPIO_DM_HIGHZ, P11_6_AUDIOSS1_RX_SDI},
	{&CYHAL_I2S_1, P13_6, (uint8_t)CY_GPIO_DM_HIGHZ, P13_6_AUDIOSS1_RX_SDI},
};

/* Connections for: audioss_rx_ws */
const cyhal_resource_pin_mapping_t cyhal_pin_map_audioss_rx_ws[4] = {
	{&CYHAL_I2S_0, P5_5, (uint8_t)CY_GPIO_DM_STRONG_IN_OFF, P5_5_AUDIOSS0_RX_WS},
	{&CYHAL_I2S_0, P9_5, (uint8_t)CY_GPIO_DM_STRONG_IN_OFF, P9_5_AUDIOSS0_RX_WS},
	{&CYHAL_I2S_1, P11_5, (uint8_t)CY_GPIO_DM_STRONG_IN_OFF, P11_5_AUDIOSS1_RX_WS},
	{&CYHAL_I2S_1, P13_5, (uint8_t)CY_GPIO_DM_STRONG_IN_OFF, P13_5_AUDIOSS1_RX_WS},
};
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_audioss_tx_sck[4] = {
	...
	{&CYHAL_I2S_1, P13_1, (uint8_t)CY_GPIO_DM_STRONG_IN_OFF, P13_1_AUDIOSS1_TX_SCK},
};

/* Connections for: audioss_tx_sdo */
const cyhal_resource_pin_mapping_t cyhal_pin_map_audioss_tx_sdo[4] = {
	{&CYHAL_I2S_0, P5_3, (uint8_t)CY_GPIO_DM_STRONG_IN_OFF, P5_3_AUDIOSS0_TX_SDO},
	...
	{&CYHAL_I2S_1, P13_3, (uint8_t)CY_GPIO_DM_STRONG_IN_OFF, P13_3_AUDIOSS1_TX_SDO},
};

/* Connections for: audioss_tx_ws */
const cyhal_resource_pin_mapping_t cyhal_pin_map_audioss_tx_ws[4] = {
	{&CYHAL_I2S_0, P5_2, (uint8_t)CY_GPIO_DM_STRONG_IN_OFF, P5_2_AUDIOSS0_TX_WS},
	...
	{&CYHAL_I2S_1, P13_2, (uint8_t)CY_GPIO_DM_STRONG_IN_OFF, P13_2_AUDIOSS1_TX_WS},
};
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_scb_i2c_scl[21] = {
	...
	{&CYHAL_SCB_10, P5_4, (uint8_t)CY_GPIO_DM_OD_DRIVESLOW, P5_4_SCB10_I2C_SCL},
	...
	{&CYHAL_SCB_11, P8_4, (uint8_t)CY_GPIO_DM_OD_DRIVESLOW, P8_4_SCB11_I2C_SCL},
	...
	{&CYHAL_SCB_12, P13_4, (uint8_t)CY_GPIO_DM_OD_DRIVESLOW, P13_4_SCB12_I2C_SCL},
};
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_scb_i2c_sda[21] = {
	...
	{&CYHAL_SCB_10, P5_5, (uint8_t)CY_GPIO_DM_OD_DRIVESLOW, P5_5_SCB10_I2C_SDA},
	...
	{&CYHAL_SCB_11, P8_5, (uint8_t)CY_GPIO_DM_OD_DRIVESLOW, P8_5_SCB11_I2C_SDA},
	...
	{&CYHAL_SCB_12, P13_5, (uint8_t)CY_GPIO_DM_OD_DRIVESLOW, P13_5_SCB12_I2C_SDA},
};
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_scb_spi_m_clk[17] = {
	...
	{&CYHAL_SCB_2, P3_2, (uint8_t)CY_GPIO_DM_STRONG_IN_OFF, P3_2_SCB2_SPI_CLK},
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_scb_spi_m_select0[17] = {
	...
	{&CYHAL_SCB_2, P3_3, (uint8_t)CY_GPIO_DM_STRONG_IN_OFF, P3_3_SCB2_SPI_SELECT0},
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_scb_spi_m_select1[13] = {
	...
	{&CYHAL_SCB_2, P3_4, (uint8_t)CY_GPIO_DM_STRONG_IN_OFF, P3_4_SCB2_SPI_SELECT1},
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_scb_spi_m_select2[13] = {
	...
	{&CYHAL_SCB_2, P3_5, (uint8_t)CY_GPIO_DM_STRONG_IN_OFF, P3_5_SCB2_SPI_SELECT2},
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_scb_spi_s_clk[17] = {
	...
	{&CYHAL_SCB_2, P3_2, (uint8_t)CY_GPIO_DM_HIGHZ, P3_2_SCB2_SPI_CLK},
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_scb_spi_s_select0[17] = {
	...
	{&CYHAL_SCB_2, P3_3, (uint8_t)CY_GPIO_DM_HIGHZ, P3_3_SCB2_SPI_SELECT0},
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_scb_spi_s_select1[13] = {
	...
	{&CYHAL_SCB_2, P3_4, (uint8_t)CY_GPIO_DM_HIGHZ, P3_4_SCB2_SPI_SELECT1},
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_scb_spi_s_select2[13] = {
	...
	{&CYHAL_SCB_2, P3_5, (uint8_t)CY_GPIO_DM_HIGHZ, P3_5_SCB2_SPI_SELECT2},
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_scb_uart_cts[19] = {
	...
	{&CYHAL_SCB_2, P3_3, (uint8_t)CY_GPIO_DM_HIGHZ, P3_3_SCB2_UART_CTS},
	...
	{&CYHAL_SCB_11, P8_7, (uint8_t)CY_GPIO_DM_HIGHZ, P8_7_SCB11_UART_CTS},
	...
	{&CYHAL_SCB_12, P13_7, (uint8_t)CY_GPIO_DM_HIGHZ, P13_7_SCB12_UART_CTS},
};
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_scb_uart_rts[19] = {
	...
	{&CYHAL_SCB_11, P8_6, (uint8_t)CY_GPIO_DM_STRONG_IN_OFF, P8_6_SCB11_UART_RTS},
	...
	{&CYHAL_SCB_12, P13_6, (uint8_t)CY_GPIO_DM_STRONG_IN_OFF, P13_6_SCB12_UART_RTS},
};
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_sdhc_card_cmd[2] = {
	...
	{&CYHAL_SDHC_1, P12_4, (uint8_t)CY_GPIO_DM_STRONG, P12_4_SDHC1_CARD_CMD},
};
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_sdhc_card_dat_3to0[8] = {
	...
	{&CYHAL_SDHC_1, P13_0, (uint8_t)CY_GPIO_DM_STRONG, P13_0_SDHC1_CARD_DAT_3TO00},
	{&CYHAL_SDHC_1, P13_1, (uint8_t)CY_GPIO_DM_STRONG, P13_1_SDHC1_CARD_DAT_3TO01},
	{&CYHAL_SDHC_1, P13_2, (uint8_t)CY_GPIO_DM_STRONG, P13_2_SDHC1_CARD_DAT_3TO02},
	{&CYHAL_SDHC_1, P13_3, (uint8_t)CY_GPIO_DM_STRONG, P13_3_SDHC1_CARD_DAT_3TO03},
};
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_sdhc_card_detect_n[2] = {
	...
	{&CYHAL_SDHC_1, P12_1, (uint8_t)CY_GPIO_DM_HIGHZ, P12_1_SDHC1_CARD_DETECT_N},
};

/* Connections for: sdhc_card_emmc_reset_n */
const cyhal_resource_pin_mapping_t cyhal_pin_map_sdhc_card_emmc_reset_n[1] = {
	{&CYHAL_SDHC_1, P12_0, (uint8_t)CY_GPIO_DM_STRONG_IN_OFF, P12_0_SDHC1_CARD_EMMC_RESET_N},
};
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_sdhc_card_mech_write_prot[2] = {
	...
	{&CYHAL_SDHC_1, P12_2, (uint8_t)CY_GPIO_DM_HIGHZ, P12_2_SDHC1_CARD_MECH_WRITE_PROT},
};
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_sdhc_clk_card[2] = {
	...
	{&CYHAL_SDHC_1, P12_5, (uint8_t)CY_GPIO_DM_STRONG, P12_5_SDHC1_CLK_CARD},
};
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_sdhc_led_ctrl[1] = {
	{&CYHAL_SDHC_1, P12_3, (uint8_t)CY_GPIO_DM_STRONG_IN_OFF, P12_3_SDHC1_LED_CTRL},
};
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_tcpwm_line[100] = {
	...
	{&CYHAL_TCPWM_0_3, P3_2, (uint8_t)CY_GPIO_DM_STRONG_IN_OFF, P3_2_TCPWM0_LINE3},
	{&CYHAL_TCPWM_1_20, P3_2, (uint8_t)CY_GPIO_DM_STRONG_IN_OFF, P3_2_TCPWM1_LINE20},
	{&CYHAL_TCPWM_0_4, P3_4, (uint8_t)CY_GPIO_DM_STRONG_IN_OFF, P3_4_TCPWM0_LINE4},
	{&CYHAL_TCPWM_1_21, P3_4, (uint8_t)CY_GPIO_DM_STRONG_IN_OFF, P3_4_TCPWM1_LINE21},
	{&CYHAL_TCPWM_0_5, P4_0, (uint8_t)CY_GPIO_DM_STRONG_IN_OFF, P4_0_TCPWM0_LINE5},
	{&CYHAL_TCPWM_1_22, P4_0, (uint8_t)CY_GPIO_DM_STRONG_IN_OFF, P4_0_TCPWM1_LINE22},
	{&CYHAL_TCPWM_0_6, P4_2, (uint8_t)CY_GPIO_DM_STRONG_IN_OFF, P4_2_TCPWM0_LINE6},
	{&CYHAL_TCPWM_1_23, P4_2, (uint8_t)CY_GPIO_DM_STRONG_IN_OFF, P4_2_TCPWM1_LINE23},
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_tcpwm_line_compl[100] = {
	...
	{&CYHAL_TCPWM_0_3, P3_3, (uint8_t)CY_GPIO_DM_STRONG_IN_OFF, P3_3_TCPWM0_LINE_COMPL3},
	{&CYHAL_TCPWM_1_20, P3_3, (uint8_t)CY_GPIO_DM_STRONG_IN_OFF, P3_3_TCPWM1_LINE_COMPL20},
	{&CYHAL_TCPWM_0_4, P3_5, (uint8_t)CY_GPIO_DM_STRONG_IN_OFF, P3_5_TCPWM0_LINE_COMPL4},
	{&CYHAL_TCPWM_1_21, P3_5, (uint8_t)CY_GPIO_DM_STRONG_IN_OFF, P3_5_TCPWM1_LINE_COMPL21},
	{&CYHAL_TCPWM_0_5, P4_1, (uint8_t)CY_GPIO_DM_STRONG_IN_OFF, P4_1_TCPWM0_LINE_COMPL5},
	{&CYHAL_TCPWM_1_22, P4_1, (uint8_t)CY_GPIO_DM_STRONG_IN_OFF, P4_1_TCPWM1_LINE_COMPL22},
	{&CYHAL_TCPWM_0_6, P4_3, (uint8_t)CY_GPIO_DM_STRONG_IN_OFF, P4_3_TCPWM0_LINE_COMPL6},
	{&CYHAL_TCPWM_1_23, P4_3, (uint8_t)CY_GPIO_DM_STRONG_IN_OFF, P4_3_TCPWM1_LINE_COMPL23},
