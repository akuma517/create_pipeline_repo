...
const uint8_t cyhal_dest_to_mux[112] =
{
	...
	11, /* TRIGGER_PASS_DSI_CTDAC_STROBE */
	9, /* TRIGGER_PASS_TR_SAR_IN0 */
	9, /* TRIGGER_PASS_TR_SAR_IN1 */
	7, /* TRIGGER_PERI_TR_DBG_FREEZE */
	4, /* TRIGGER_PERI_TR_IO_OUTPUT0 */
	4, /* TRIGGER_PERI_TR_IO_OUTPUT1 */
	2, /* TRIGGER_TCPWM0_TR_ALL_CNT_IN0 */
	2, /* TRIGGER_TCPWM0_TR_ALL_CNT_IN1 */
	2, /* TRIGGER_TCPWM0_TR_ALL_CNT_IN2 */
	2, /* TRIGGER_TCPWM0_TR_ALL_CNT_IN3 */
	2, /* TRIGGER_TCPWM0_TR_ALL_CNT_IN4 */
	2, /* TRIGGER_TCPWM0_TR_ALL_CNT_IN5 */
	2, /* TRIGGER_TCPWM0_TR_ALL_CNT_IN6 */
	2, /* TRIGGER_TCPWM0_TR_ALL_CNT_IN7 */
	2, /* TRIGGER_TCPWM0_TR_ALL_CNT_IN8 */
	2, /* TRIGGER_TCPWM0_TR_ALL_CNT_IN9 */
	2, /* TRIGGER_TCPWM0_TR_ALL_CNT_IN10 */
	2, /* TRIGGER_TCPWM0_TR_ALL_CNT_IN11 */
	2, /* TRIGGER_TCPWM0_TR_ALL_CNT_IN12 */
	2, /* TRIGGER_TCPWM0_TR_ALL_CNT_IN13 */
	3, /* TRIGGER_TCPWM0_TR_ALL_CNT_IN14 */
	3, /* TRIGGER_TCPWM0_TR_ALL_CNT_IN15 */
	3, /* TRIGGER_TCPWM0_TR_ALL_CNT_IN16 */
	3, /* TRIGGER_TCPWM0_TR_ALL_CNT_IN17 */
	3, /* TRIGGER_TCPWM0_TR_ALL_CNT_IN18 */
	3, /* TRIGGER_TCPWM0_TR_ALL_CNT_IN19 */
	3, /* TRIGGER_TCPWM0_TR_ALL_CNT_IN20 */
	3, /* TRIGGER_TCPWM0_TR_ALL_CNT_IN21 */
	3, /* TRIGGER_TCPWM0_TR_ALL_CNT_IN22 */
	3, /* TRIGGER_TCPWM0_TR_ALL_CNT_IN23 */
	3, /* TRIGGER_TCPWM0_TR_ALL_CNT_IN24 */
	3, /* TRIGGER_TCPWM0_TR_ALL_CNT_IN25 */
	3, /* TRIGGER_TCPWM0_TR_ALL_CNT_IN26 */
	3, /* TRIGGER_TCPWM0_TR_ALL_CNT_IN27 */
	7, /* TRIGGER_TCPWM0_TR_DEBUG_FREEZE */
...
const uint8_t cyhal_mux_dest_index[112] =
{
	...
	0, /* TRIGGER_PASS_DSI_CTDAC_STROBE */
	0, /* TRIGGER_PASS_TR_SAR_IN0 */
	1, /* TRIGGER_PASS_TR_SAR_IN1 */
	0, /* TRIGGER_PERI_TR_DBG_FREEZE */
	0, /* TRIGGER_PERI_TR_IO_OUTPUT0 */
	1, /* TRIGGER_PERI_TR_IO_OUTPUT1 */
	0, /* TRIGGER_TCPWM0_TR_ALL_CNT_IN0 */
	1, /* TRIGGER_TCPWM0_TR_ALL_CNT_IN1 */
	2, /* TRIGGER_TCPWM0_TR_ALL_CNT_IN2 */
	3, /* TRIGGER_TCPWM0_TR_ALL_CNT_IN3 */
	4, /* TRIGGER_TCPWM0_TR_ALL_CNT_IN4 */
	5, /* TRIGGER_TCPWM0_TR_ALL_CNT_IN5 */
	6, /* TRIGGER_TCPWM0_TR_ALL_CNT_IN6 */
	7, /* TRIGGER_TCPWM0_TR_ALL_CNT_IN7 */
	8, /* TRIGGER_TCPWM0_TR_ALL_CNT_IN8 */
	9, /* TRIGGER_TCPWM0_TR_ALL_CNT_IN9 */
	10, /* TRIGGER_TCPWM0_TR_ALL_CNT_IN10 */
	11, /* TRIGGER_TCPWM0_TR_ALL_CNT_IN11 */
	12, /* TRIGGER_TCPWM0_TR_ALL_CNT_IN12 */
	13, /* TRIGGER_TCPWM0_TR_ALL_CNT_IN13 */
	0, /* TRIGGER_TCPWM0_TR_ALL_CNT_IN14 */
	1, /* TRIGGER_TCPWM0_TR_ALL_CNT_IN15 */
	2, /* TRIGGER_TCPWM0_TR_ALL_CNT_IN16 */
	3, /* TRIGGER_TCPWM0_TR_ALL_CNT_IN17 */
	4, /* TRIGGER_TCPWM0_TR_ALL_CNT_IN18 */
	5, /* TRIGGER_TCPWM0_TR_ALL_CNT_IN19 */
	6, /* TRIGGER_TCPWM0_TR_ALL_CNT_IN20 */
	7, /* TRIGGER_TCPWM0_TR_ALL_CNT_IN21 */
	8, /* TRIGGER_TCPWM0_TR_ALL_CNT_IN22 */
	9, /* TRIGGER_TCPWM0_TR_ALL_CNT_IN23 */
	10, /* TRIGGER_TCPWM0_TR_ALL_CNT_IN24 */
	11, /* TRIGGER_TCPWM0_TR_ALL_CNT_IN25 */
	12, /* TRIGGER_TCPWM0_TR_ALL_CNT_IN26 */
	13, /* TRIGGER_TCPWM0_TR_ALL_CNT_IN27 */
	1, /* TRIGGER_TCPWM0_TR_DEBUG_FREEZE */
